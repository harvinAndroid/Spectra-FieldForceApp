...
public class AttachmentIrFrag extends BottomSheetDialogFragment {
    ...
    private String str_ext3="",currentImagePath;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        getDocumentDetails();
        binding.etAttach.setOnClickListener(view1 -> checkPermissionAttach(Manifest.permission.CAMERA, REQUEST_CAMERA_PERMISSION_ONE));
    ...
    private void moveNext(){
        ...
        AttachmentIrFrag attachmentWcrFrag = new AttachmentIrFrag();
    ...
    private void updateDoc(String encodedPathhh, String str_ext33) {
        ...
        createWcrIrDocReq.setWcrId("");
        createWcrIrDocReq.setIrId(strGuuId);
