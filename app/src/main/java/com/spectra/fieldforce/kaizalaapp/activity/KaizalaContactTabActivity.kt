...
class KaizalaContactTabActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = tabLayout?.tabCount?.let { KaiContactTabAdapter(this, supportFragmentManager, it) }
