...
import com.spectra.fieldforce.kaizalaapp.adapter.KaiCafTabAdapter
...
class KaizalaCafTabActivity : AppCompatActivity(), View.OnClickListener {
...
try {
    ...
    val adapter = KaiCafTabAdapter(this, supportFragmentManager, tabLayout.tabCount)
